...
public class MimeTypes {
	...
	public static String getMimeType(FileExtension fileExtension) {
		String mimeType = mimeTypes.get(fileExtension.toString().toLowerCase());
		return StringUtils.isNotEmpty(mimeType) ? mimeType : "text/plain";
	}

	public static String getMimeType(String filename) {
		for (FileExtension fileExtension : FileExtension.values()) {
			if (StringUtils.endsWithIgnoreCase(filename, fileExtension.toString())) {
				return getMimeType(fileExtension);
			}
		}
		return getMimeType(FileExtension.TXT);
	}
}