...
public final class MicroWebsocket {

	private static final Logger logger = LoggerFactory.getLogger(MicroWebsocket.class);
	...
	public static void main(final String[] args) {
		...
		try {
			...
			ServerFactory.startWebSocketServer(port);
